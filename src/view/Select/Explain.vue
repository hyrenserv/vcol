<template>
  <div>
    <el-collapse accordion>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                在输入框按下回车，选择第一个匹配项。需配合
                <code>filterable</code> 或
                <code>remote</code> 使用
              </td>
              <td>boolean</td>
              <td>-</td>
      ...
      <el-collapse-item title="插槽" name="3">
        <table>
          <thead>
            <tr>
              <th>name</th>
      ...
      <el-collapse-item title="Option组属性" name="4">
        <table>
          <thead>
            <tr>
              <th>参数</th>
      ...
      <el-collapse-item title="Option属性" name="5">
        <table>
          <thead>
            <tr>
              <th>参数</th>
      ...
      <el-collapse-item title="方法" name="6">
        <table>
          <thead>
            <tr>
              <th>方法名</th>
