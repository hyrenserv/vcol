<template>
  ...
  <el-collapse-item title="方法" name="2">
    <table>
      <thead>
        <tr>
          <th>方法名</th>
 ...
 <el-collapse-item title="事件" name="3">
  ...
  <el-collapse-item title="Form-Item 属性" name="4">
    <table>
      <thead>
        <tr>
          <th>参数</th>
      ...
      <tbody>
        ...
        <tr>
          <td>error</td>
          <td>
            表单域验证错误信息, 设置该值会使表单验证状态变为
            <code>error</code>，并显示该错误信息
          </td>
          <td>string</td>
          <td>—</td>
          <td>—</td>
    ...
    <el-collapse-item title="Form-Item Slot" name="5">
    <table>
      <thead>
        <tr>
          <th>name</th>
     ...
     <el-collapse-item title="Form-Item Scoped Slot" name="6">
    <table>
      <thead>
        <tr>
          <th>name</th>
     ...
     <el-collapse-item title="Form-Item 方法" name="7">
    <table>
      <thead>
        <tr>
          <th>方法名</th>
